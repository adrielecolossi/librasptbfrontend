...
function ExibirMarcarLacuna() {
  ...
  const excluiQuestao = async (id) => {
    axiosClient
      .delete("/excluirQuestaoMarcarLacuna", {
        data: {
        id,
        token,
      }
  ...
  function openModal(id) {
    ...
    setFraseQuestao(dadosDaQuestao.frase);
  ...
  if (isLoggedIn === "loggedIn" || isLoggedIn === undefined) {
    return (
      <>
        ...
        <Banner>
          <Title>
            <h1>Questões de Marcar Lacuna com Alternativa </h1>
            <h2>
              Pesquise para ver todas as questões de marcar alternativa para
              preencher uma frase de uma dada categoria
            </h2>
          </Title>
          <img
            src="https://drive.google.com/uc?id=169RNcKlK-Cbba4sb99Z1LgBL1atLjjd6"
            alt=""
          />
        </Banner>
        <br></br>
...
export default ExibirMarcarLacuna;
